   ...
   const uploadImage=async()=>{
    ...
    //}
      ...
      uploadTask.on('state_changed',
        ...
        (error)=>{
          setImageFileUploadError('Could not upload image (File must be leass than 2MB)');
         ...
         <input type="file" accept='image/*' onChange={handleImageChange} ref={filePickerRef} hidden/>
           ...
           {imageFileUploadError && <Alert color='failure'>{imageFileUploadError}</Alert>}
            ...
            <TextInput type='password' id='password' placeholder='password'/>
             {/* outline matlab ki sirf hover karne par hi button me pura color fill hoga wanrna hover se phele tou sirf border pr hi colour dekhega */}
